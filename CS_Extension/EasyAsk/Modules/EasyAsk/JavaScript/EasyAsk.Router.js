    ...
    , function (
        ...
        return _.extend(FacetsRouter.prototype, {
            ...
            , processURL: function(path, model)
            {
                ...
                ,   curPath2 = window.location.hash != '' ? curURL.hash : curURL.pathname;

                console.log("curPath2", curPath2);
                console.log("path", path);
                
                if(curPath2.indexOf('search') >= 0)
                {
                    var lastIndex = path.indexOf('?') >= 0 ? path.indexOf('?') : path.length;
                    console.log("lastIndex", lastIndex);

                    if(curPath2.indexOf('Brand') >= 0)
                    {
                        console.log("curPath indexOf");

                        path = path.substring(path.indexOf('/'), lastIndex);

                        console.log("path gian", path);
                    }
                    else
                    {
                        console.log("curPath else");

                        path = 'All Products';

                        console.log("All products", path);
                    }
                }
                ...
                else
                {
                    ...
                    console.log("here category path", path);
