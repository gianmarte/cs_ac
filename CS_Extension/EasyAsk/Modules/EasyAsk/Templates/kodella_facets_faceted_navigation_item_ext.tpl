{{#if showFacet}}
<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet"
	...
	{{else}}
	<a href="#" class="facets-faceted-navigation-item-facet-group-expander" data-toggle="collapse"
		data-target="#{{htmlId}} .facets-faceted-navigation-item-facet-group-wrapper" data-type="collapse"
	...
	<div
		class="{{#if isCollapsed}} collapse {{else}} collapse in {{/if}} facets-faceted-navigation-item-facet-group-wrapper">
		<div class="facets-faceted-navigation-item-facet-group-content">
			<ul class="facets-faceted-navigation-item-facet-optionlist">
				{{#each displayValues}}
				<li>
					<a class="facets-faceted-navigation-item-facet-option {{#if isActive}}option-active{{/if}}"
						title="{{label}}" data-easeopath="{{seoPath}}" data-eahref="{{seoPath}}">
						{{#if ../isMultiSelect}}
						<input type="checkbox" class="facets-faceted-navigation-item-facet-multi"
			...
			<div class="facets-faceted-navigation-item-optionlist-extra-wrapper">
				<a class="facets-faceted-navigation-item-optionlist-extra-button" data-toggle="collapse"
					data-target="#{{htmlId}} .facets-faceted-navigation-item-facet-optionlist-extra"
