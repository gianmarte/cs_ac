<section class="facets-facet-browse{{#if isYahoo }} rival-yahoo-landing{{/if}}">
	...
	{{#if showResults}}
		<div class="facets-facet-browse-content">
			...
			<div class="facets-facet-browse-results {{#if influencer}} influencer-full-width {{/if}}" itemscope="" itemtype="https://schema.org/ItemList">
				...
				<header class="facets-facet-browse-header">
					...
					<nav class="facets-facet-browse-list-header {{#if influencer}} disable-filter {{/if}}">
...
<!-- 
 ...
 -->
		...
		<div class="influencer-content">
			<div id="influencer-section-left" class="content-banner banner-section-top influencer-bio" data-cms-area="influencer_section_left" data-cms-area-filters="path">&nbsp;</div>

			<div id="influencer-section-right" class="content-banner banner-section-top influencer-video" data-cms-area="influencer_section_right" data-cms-area-filters="path">&nbsp;</div>
		</div>

		<!-- KODELLA -->
		<div id="influencer-section-bottom" class="influencer-instagram" data-cms-area="influencer_section_bottom" data-cms-area-filters="path">&nbsp;</div>
...
Use the following context variables when customizing this template:
	...
	// KODELLA
	isYahoo (Boolean) - Used to determine the Yahoo Landing Page layouts for NetSuite
