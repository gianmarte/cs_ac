				...
				<ul class="product-details-information-content-tabs" role="tablist">
					...
					{{/each}}
						...
						<!-- <li class="product-details-information-tab-title" role="presentation">
							<a href="#" data-action="selected-tab" data-id="pdp-how-to-use" data-target="#product-how-to-use-information-tab" data-toggle="tab">How to Use</a>
						</li>
						<li class="product-details-information-tab-title" role="presentation">
							<a href="#" data-action="selected-tab" data-id="pdp-ingredients" data-target="#product-ingredients-information-tab" data-toggle="tab">Ingredients</a>
						</li> -->
